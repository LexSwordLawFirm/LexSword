  ...
  return (
    <div className="font-sans text-slate-800 bg-white selection:bg-[#c5a059] selection:text-white overflow-x-hidden">
      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ?
        'bg-white shadow-lg py-2' : 'bg-transparent py-4 md:py-6'}`}>
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className={`p-2 rounded-full border-2 ${scrolled ?
              'border-[#c5a059] text-[#c5a059]' : 'border-white text-[#c5a059]'}`}>
              <Scale size={22} />
            </div>
            <div>
              <h1 className={`text-2xl font-serif font-bold tracking-widest ${scrolled ?
                'text-slate-900' : 'text-white'}`}>LEXSWORD</h1>
              <p className={`text-[10px] font-bold tracking-[0.3em] uppercase ${scrolled ?
                'text-gray-500' : 'text-gray-300'} mt-1`}>Chambers of Law</p>
            </div>
          </div>
          <div className={`hidden lg:flex items-center gap-8 text-sm font-bold uppercase tracking-wider ${scrolled ?
          ...
          <div className="hidden md:flex items-center gap-6">
             <a href="tel:+8801911008518" className="flex items-center gap-3 group">
                ...
                <div className={`${scrolled ?
                  'text-slate-800' : 'text-white'} leading-tight`}>
                   <p className="text-[10px] opacity-80 uppercase">Call for Consultation</p>
                   <p className="font-bold text-lg">+88 01911 008 518</p>
                </div>
             </a>
             <button onClick={onLoginClick} className="bg-[#c5a059] text-white px-5 py-2 rounded-sm 
                font-bold text-xs uppercase tracking-wide hover:bg-slate-900 transition shadow-md">
                {loading ?
                '...' : 'Login Portal'}
             </button>
          </div>
          <button onClick={() => setMenuOpen(!menuOpen)} className={`lg:hidden ${scrolled ?
      ...
      {/* 1. HERO SECTION */}
      <header id="home" className="relative min-h-screen flex items-center bg-soft-blue-gradient overflow-hidden pt-32 md:pt-48 
        pb-48">
      ...
      <section className="relative z-20 -mt-16 md:-mt-24 px-4 md:px-0">
          <div className="max-w-7xl mx-auto grid md:grid-cols-3 shadow-2xl reveal-modern delay-200">
             <div className="bg-[#fdfaf5] p-10 md:p-12 text-center group hover:-translate-y-2 transition duration-300 border-b-4 border-transparent hover:border-[#c5a059]">
                ...
                <h3 
                className="text-xl font-serif font-bold text-slate-900 mb-3">Case Evaluation</h3>
             ...
             <div className="bg-[#cfa660] p-10 md:p-12 text-center group hover:-translate-y-2 transition duration-300 relative overflow-hidden border-b-4 border-transparent hover:border-white">
                <div className="text-white mb-4 flex justify-center group-hover:scale-110 
                transition"><Search size={48}/></div>
      ...
      <section id="about" className="py-20 md:py-28 bg-white overflow-hidden">
         <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
             ...
             <div className="space-y-6 reveal-modern delay-200">
                 ...
                 <p className="text-gray-600 text-lg leading-relaxed">Founded in {establishedYear}, LexSword Chambers is led by Advocate Azadur Rahman of the Supreme Court of Bangladesh.
                 We combine deep legal knowledge with a modern, client-focused approach.</p>
         ...
         <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 reveal-modern">
               <div>
                  ...
                  <h2 
                  className="text-4xl font-serif font-bold text-white">Areas of Practice</h2>
            ...
            <div className="grid 
            grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 reveal-modern delay-100">
         ...
         <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-6 reveal-modern delay-200">
             <div className="group relative bg-white shadow-xl rounded-sm overflow-hidden hover:-translate-y-2 transition duration-300">
                 <div className="overflow-hidden h-[350px]">
                   ...
                   <img src="/head.jpg" alt="Adv.
                   Azadur Rahman" className="w-full h-full object-cover object-top transition duration-500 group-hover:scale-110 grayscale group-hover:grayscale-0"/>
                 </div>
                 <div className="bg-soft-blue-solid text-white p-6 text-center relative z-10 border-b-4 border-[#c5a059]">
                    ...
                    text-xs uppercase tracking-wider mt-1 font-bold">Head of Chamber</p>
             ...
             <div className="group relative bg-white shadow-xl rounded-sm overflow-hidden hover:-translate-y-2 transition duration-300">
                 ...
                 text-center relative z-10 border-b-4 border-[#c5a059] group-hover:bg-soft-blue-solid group-hover:text-white transition">
                    <h3 className="text-lg font-serif font-bold truncate">Adv.
                    Abdur Razzak</h3>
              ...
              <div className="group 
              relative bg-white shadow-xl rounded-sm overflow-hidden hover:-translate-y-2 transition duration-300">
                 <div className="overflow-hidden h-[350px]">
                 ...
                 <div className="bg-white text-slate-900 p-6 text-center relative z-10 border-b-4 
                 border-[#c5a059] group-hover:bg-soft-blue-solid group-hover:text-white transition">
                    <h3 className="text-lg font-serif font-bold truncate">Adv.
                    Tariqul Islam</h3>
                    <p className="text-[#c5a059] text-xs uppercase tracking-wider mt-1 font-bold">Associate Lawyer</p>
                    <p className="text-gray-500 group-hover:text-gray-300 text-[10px] mt-1">Judge Court</p>
      ...
      <section className="bg-soft-blue-gradient py-20 px-6 relative overflow-hidden">
         ...
         <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 reveal-modern relative z-10">
            ...
            <div className="flex-1 text-center md:text-left">
               ...
               md:text-4xl font-serif font-bold text-white mb-6 leading-tight">
                  LexSword Chambers: Your Trusted Partner for <span className="text-[#c5a059]">Legal Solutions</span> in Bangladesh.
               </h2>
               <p className="text-gray-300 max-w-2xl text-lg">
                  Since {establishedYear}, we have been dedicated to providing strategic, result-oriented legal counsel.
                  We take pride in our track record of success and our commitment to client satisfaction.
               </p>
            </div>
         </div>
      </section>
       ...
       <section id="contact" className="py-24 bg-white relative">
         <div className="max-w-7xl mx-auto px-6 reveal-modern">
            <div className="bg-white shadow-2xl rounded-xl overflow-hidden flex flex-col md:flex-row">
               <div 
               className="bg-soft-blue-solid p-12 md:w-2/5 text-white flex flex-col justify-between relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                     ...
                     <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                           ...
                           bg-[#c5a059] flex items-center justify-center text-slate-900 shrink-0"><Mail size={24}/></div>
                           <div className="overflow-hidden">
                              <p className="text-xs text-[#c5a059] uppercase font-bold">Email</p>
                              <p className="text-lg 
                              font-bold truncate">lexsword.bd@gmail.com</p>
                           </div>
                        </div>
               ...
               <div className="p-12 md:w-3/5 bg-gray-50">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                     ...
                     <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <select name="service" className="w-full bg-white 
                        border border-gray-300 p-4 outline-none focus:border-[#c5a059] text-sm rounded-sm font-medium text-slate-500">
                     ...
                     <button type="submit" disabled={isSubmitting} className="bg-soft-blue-solid text-white px-10 py-4 rounded-sm font-bold tracking-widest hover:bg-[#c5a059] hover:text-slate-900 transition uppercase w-full md:w-auto flex justify-center items-center gap-2 shadow-lg">
                        {isSubmitting ?
                        <span className="loading loading-spinner loading-sm"></span> : "Submit Request"}
                     </button>
                  </form>
               </div>
            </div>
         ...
         <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10 mb-12 text-sm">
            <div>
               ...
               <div className="flex gap-4">
                  <a href="#" className="w-10 h-10 rounded-full border border-gray-600 flex items-center justify-center hover:bg-[#c5a059] hover:border-[#c5a059] 
                  hover:text-white transition">Fb</a>
            ...
            <div>
               ...
               <ul className="space-y-3">
                  ...
                  <li><a href="#about" 
                  className="hover:text-[#c5a059] transition flex items-center gap-2"><ChevronRight size={14} className="text-[#c5a059]"/> About Us</a></li>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white p-8 rounded-sm shadow-2xl w-full max-w-md border-t-4 border-[#c5a059] text-center animate-[bounce-in_0.5s]">
             ...
             <h3 
             className="text-2xl font-serif font-bold text-slate-900 mb-2">Submission Received</h3>
    ...
    <div className="flex h-screen bg-slate-100 font-sans overflow-hidden text-slate-900">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white flex flex-col shadow-2xl transition-transform duration-300 ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:static no-print`}>
        ...
        <nav className="flex-1 p-4 space-y-2 mt-4 overflow-y-auto">
          <button onClick={() => {setActiveTab('dashboard'); setMobileMenuOpen(false);}} className={`w-full flex items-center gap-3 p-3 rounded transition ${activeTab === 'dashboard' ?
            'bg-[#c5a059] text-slate-900 font-bold' : 'text-gray-400 hover:bg-slate-800'}`}>
            <Gavel size={20}/> My Cases
          </button>
          <button onClick={() => {setActiveTab('calendar');
            setMobileMenuOpen(false);}} className={`w-full flex items-center gap-3 p-3 rounded transition ${activeTab === 'calendar' ?
            'bg-[#c5a059] text-slate-900 font-bold' : 'text-gray-400 hover:bg-slate-800'}`}>
          ...
          {activeTab === 'dashboard' && (
            <div>
              ...
              <div className="flex gap-0 mb-4 border-b-2 border-slate-300">
                  <button onClick={() => { setMainCaseTab('judge');
                    setCaseFilter('all'); }} className={`px-6 py-3 font-bold text-lg transition-all ${mainCaseTab === 'judge' ?
                    'border-b-4 border-[#c5a059] text-slate-900 bg-white' : 'text-gray-500 hover:text-slate-700'}`}>
                      Judge Court ({getCounts('judge').all})
                  </button>
                  <button onClick={() => { setMainCaseTab('high');
                    setCaseFilter('all'); }} className={`px-6 py-3 font-bold text-lg transition-all ${mainCaseTab === 'high' ?
                    'border-b-4 border-[#c5a059] text-slate-900 bg-white' : 'text-gray-500 hover:text-slate-700'}`}>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                (
                    <>
                        ...
                        <button onClick={() => setCaseFilter('pending')} className={`px-3 py-1 rounded-full text-sm font-bold border ${caseFilter === 'pending' ? 
                          'bg-[#c5a059] text-slate-900' : 'bg-white'}`}>Pending ({currentCounts.pending})</button>
                        ...
                        <button onClick={() => setCaseFilter('tomorrow')} className={`px-3 py-1 rounded-full text-sm font-bold border ${caseFilter === 'tomorrow' ?
                          'bg-[#c5a059] text-slate-900' : 'bg-white'}`}>Tomorrow ({currentCounts.tomorrow})</button>
                        <button onClick={() => setCaseFilter('week')} className={`px-3 py-1 rounded-full text-sm font-bold border ${caseFilter === 'week' ?
                          'bg-[#c5a059] text-slate-900' : 'bg-white'}`}>This Week ({currentCounts.week})</button>
                        <button onClick={() => setCaseFilter('update')} className={`px-3 py-1 rounded-full text-sm font-bold border transition ${currentCounts.update > 0 ?
                          'bg-red-600 text-white border-red-600 animate-pulse' : 'bg-white text-slate-600'}`}>Needs Update ({currentCounts.update})</button>
                    </>
                ) : (
                    <>
                        <button onClick={() => setCaseFilter('all')} className={`px-3 py-1 rounded-full text-sm font-bold border 
                        ${caseFilter === 'all' ? 'bg-[#c5a059] text-slate-900' : 'bg-white'}`}>All ({currentCounts.all})</button>
                        ...
                        <button onClick={() => setCaseFilter('update')} className={`px-3 py-1 rounded-full text-sm font-bold border transition ${currentCounts.update > 0 ?
                          'bg-red-600 text-white border-red-600 animate-pulse' : 'bg-white text-slate-600'}`}>Needs Update ({currentCounts.update})</button>
                        <button onClick={() => setCaseFilter('Writ Petition')} className={`px-3 py-1 rounded-full text-sm font-bold border ${caseFilter === 'Writ Petition' ?
                          'bg-[#c5a059] text-slate-900' : 'bg-white'}`}>Writ ({currentCounts.writ})</button>
                        <button onClick={() => setCaseFilter('Civil Revision')} className={`px-3 py-1 rounded-full text-sm font-bold border ${caseFilter === 'Civil Revision' ?
                          'bg-[#c5a059] text-slate-900' : 'bg-white'}`}>Civil Rev ({currentCounts.civilRev})</button>
                        <button onClick={() => setCaseFilter('Criminal Revision')} className={`px-3 py-1 rounded-full text-sm font-bold border ${caseFilter === 'Criminal Revision' ?
                          'bg-[#c5a059] text-slate-900' : 'bg-white'}`}>Crim Rev ({currentCounts.crimRev})</button>
                        <button onClick={() => setCaseFilter('Civil Appeal')} className={`px-3 py-1 rounded-full text-sm font-bold border ${caseFilter === 'Civil Appeal' ?
                          'bg-[#c5a059] text-slate-900' : 'bg-white'}`}>Civil Appeal ({currentCounts.civilApp})</button>
                        <button onClick={() => setCaseFilter('Criminal Appeal')} className={`px-3 py-1 rounded-full text-sm font-bold border ${caseFilter === 'Criminal Appeal' ?
                          'bg-[#c5a059] text-slate-900' : 'bg-white'}`}>Crim Appeal ({currentCounts.crimApp})</button>
                        <button onClick={() => setCaseFilter('Misc Case')} className={`px-3 py-1 rounded-full text-sm font-bold border ${caseFilter === 'Misc Case' ?
                          'bg-[#c5a059] text-slate-900' : 'bg-white'}`}>Misc ({currentCounts.misc})</button>
                    </>
                )}
              </div>
                ...
                {getFilteredCases().map(c => (
                  <div key={c.id} className="bg-white p-4 md:p-5 rounded-lg shadow border-l-4 border-slate-900 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:bg-slate-50 transition">
                    ...
                    <div className="flex gap-2 w-full md:w-auto justify-end border-t md:border-t-0 pt-4 md:pt-0 mt-2 md:mt-0">
                      <button 
                      onClick={() => { setSelectedCase(c); setModalMode('viewCase'); }} className="p-2 bg-blue-100 text-blue-800 rounded hover:bg-blue-200 font-bold flex items-center gap-2 px-4"><Eye size={18}/> View Details</button>
                    </div>
                  </div>
                ))}
              </div>
             ...
             <div className="p-6 space-y-6">
                <div className="grid grid-cols-2 gap-6 text-sm bg-slate-50 p-4 rounded border">
                   ...
                   <div>
                      ...
                      {selectedCase.note 
                      && <p className="text-sm text-slate-700 mt-3 bg-yellow-50 p-3 rounded border-l-4 border-yellow-400">{selectedCase.note}</p>}
                   </div>
                   <div className="flex items-end">
                      <button onClick={() => { fetchHistory(selectedCase.id);
                      setModalMode('history'); }} className="flex items-center gap-2 bg-slate-800 text-white px-4 py-2 rounded text-xs font-bold hover:bg-[#c5a059] transition">
         ...
         <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-lg rounded-xl shadow-2xl overflow-hidden">
               ...
               <div className="p-4 h-96 overflow-y-auto">
                  {historyLog.map((h, i) => (
                     <div 
                     key={i} className="flex gap-4 border-l-2 border-slate-300 pl-4 pb-6 relative">
...
const AdminDashboard = ({ session, userRole, onLogout }) => {
  ...
  return (
    <div className="flex h-screen bg-slate-100 font-sans overflow-hidden text-slate-900">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white flex flex-col shadow-2xl transition-transform duration-300 ${mobileMenuOpen ?
        'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:static no-print`}>
        <div className="p-6 text-2xl font-bold font-serif text-[#c5a059] border-b border-slate-800 tracking-wider flex justify-between items-center">
          CHAMBERS <button className="md:hidden text-white" onClick={() => setMobileMenuOpen(false)}><X size={24}/></button>
        </div>
        <nav className="flex-1 p-4 space-y-2 mt-4 overflow-y-auto">
          <button onClick={() => {setActiveTab('dashboard');
            setMobileMenuOpen(false);}} className={`w-full flex items-center gap-3 p-3 rounded transition ${activeTab === 'dashboard' ?
            'bg-[#c5a059] text-slate-900 font-bold' : 'text-gray-400 hover:bg-slate-800'}`}>
          ...
          {userRole === 'admin' && (
            <>
              <button onClick={() => {setActiveTab('tasks');
                setMobileMenuOpen(false);}} className={`w-full flex items-center gap-3 p-3 rounded transition ${activeTab === 'tasks' ?
                'bg-[#c5a059] text-slate-900 font-bold' : 'text-gray-400 hover:bg-slate-800'}`}>
                <ClipboardList size={20}/> Task Manager
              </button>
              <button onClick={() => {setActiveTab('accounts');
                setMobileMenuOpen(false);}} className={`w-full flex items-center gap-3 p-3 rounded transition ${activeTab === 'accounts' ?
                'bg-[#c5a059] text-slate-900 font-bold' : 'text-gray-400 hover:bg-slate-800'}`}>
                <DollarSign size={20}/> Accounts & Ledger
              </button>
              {/* NEW: Loan Management Sidebar Link */}
              <button onClick={() => {setActiveTab('loans');
                setMobileMenuOpen(false);}} className={`w-full flex items-center gap-3 p-3 rounded transition ${activeTab === 'loans' ?
                'bg-[#c5a059] text-slate-900 font-bold' : 'text-gray-400 hover:bg-slate-800'}`}>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start 
                ...
                {userRole === 'admin' && (
                  <div className="flex gap-2 w-full md:w-auto">
                    <button onClick={() => { setFormData({ file_no: '', court_type: 'Judge Court', case_nature: 'Civil Suit', status: 'Ongoing' });
                      setModalMode('addCase'); }} className="flex-1 items-center gap-2 bg-slate-900 text-white px-6 py-2 rounded shadow hover:bg-[#c5a059] font-bold flex justify-center">
              ...
              <div className="grid gap-4">
                ...
                {getFilteredCases().map(c => (
                  <div key={c.id} className="bg-white p-4 md:p-5 rounded-lg shadow border-l-4 border-slate-900 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:bg-slate-50 transition">
                    ...
                    <div className="flex gap-2 w-full md:w-auto justify-end border-t md:border-t-0 pt-4 md:pt-0 mt-2 md:mt-0">
                      <button 
                      onClick={() => { setFormData(c); setModalMode('updateStatus'); }} className="p-2 bg-slate-900 text-white rounded hover:bg-[#c5a059] font-bold flex items-center gap-1" title="Update">
                        <RefreshCw size={16}/> Update
                      </button>
                      <button onClick={() => { setSelectedCase(c);
                        setModalMode('viewCase'); }} className="p-2 bg-blue-100 text-blue-800 rounded hover:bg-blue-200"><Eye size={18}/></button>
                      
                      {userRole === 'admin' && (
                        <>
                          <button onClick={() => { setFormData(c);
                            setModalMode('addCase'); }} className="p-2 bg-yellow-100 text-yellow-800 rounded hover:bg-yellow-200"><Edit3 size={18}/></button>
          ...
          {activeTab === 'tasks' && (
            <div className="no-print">
              ...
              <div className="flex gap-4 mb-4 border-b border-slate-200 pb-2">
                 ...
                 <button onClick={() => setTaskFilter('pending')} className={`font-bold pb-2 px-2 ${taskFilter === 'pending' ?
                  'text-[#c5a059] border-b-2 border-[#c5a059]' : 'text-gray-500'}`}>To-Do List</button>
                <button onClick={() => setTaskFilter('completed')} className={`font-bold pb-2 px-2 ${taskFilter === 'completed' ?
                  'text-[#c5a059] border-b-2 border-[#c5a059]' : 'text-gray-500'}`}>Completed</button>
                <button onClick={() => setTaskFilter('all')} className={`font-bold pb-2 px-2 ${taskFilter === 'all' ?
                  'text-[#c5a059] border-b-2 border-[#c5a059]' : 'text-gray-500'}`}>All Tasks</button>
              </div>
              ...
              <div className="space-y-3">
                ...
                {getFilteredTasks().map(t => (
                  ...
                  flex items-center justify-between group transition ${t.status === 'Done' ? 'opacity-60 bg-gray-50' : 'hover:shadow-md'}`}>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className={`font-bold text-lg text-slate-900 ${t.status === 'Done' ?
                          'line-through text-gray-500' : ''}`}>{t.title}</h4>
                        ...
                        <div className="flex flex-col gap-1.5 overflow-y-auto flex-1 pr-1 custom-scrollbar">
                          {isCurrentMonth && hasCase.map(c => (
                            ...
                            <div key={c.id} onClick={(e) => { e.stopPropagation();
                              setSelectedCase(c); setModalMode('viewCase'); }} className="text-[10px] md:text-xs truncate bg-red-50 text-red-700 border border-red-200 px-2 py-1 rounded cursor-pointer hover:bg-red-600 hover:text-white transition-colors font-semibold shadow-sm flex items-center gap-1.5" title={`${c.case_no} - ${c.party_name}`}>
                              <span className="w-1.5 h-1.5 rounded-full bg-red-500 flex-shrink-0"></span> 
                              <span className="truncate">{c.case_no}</span>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 no-print">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    ...
                    <button onClick={() => { setFormData({txn_type: 'Income', category: 'Office', payment_status: 'Paid'});
                      setModalMode('addTxn'); }} className="bg-slate-900 text-white px-6 py-2 rounded font-bold hover:bg-[#c5a059] flex items-center gap-2">
              ...
              <div className="bg-white p-4 rounded shadow border border-slate-200 grid grid-cols-1 md:grid-cols-4 gap-4 no-print">
                  ...
                  <div className="col-span-1 flex items-end gap-2">
                      ...
                      <button onClick={() => {setStartDate('');
                        setEndDate(''); setAccountSearch('')}} className="p-2.5 bg-gray-200 text-gray-600 rounded hover:bg-gray-300"><RefreshCw size={16}/></button>
                  </div>
              </div>
              ...
              <div className="hidden print-only mb-6 text-center border-b pb-4">
                  ...
                  <p className="text-xs mt-2">Period: {startDate ||
                    'All Time'} to {endDate || 'Present'}</p>
              </div>
              ...
              <div className="bg-white rounded shadow overflow-x-auto">
                 <table className="w-full text-left min-w-[600px]">
                    ...
                    <tbody>
                      {filteredTxns.length === 0 && <tr><td 
                        colSpan="7" className="p-4 text-center text-slate-500 italic">No records found for this period.</td></tr>}
                      {filteredTxns.map(a => (
                        <tr key={a.id} className="border-b border-slate-100 hover:bg-slate-50">
                          <td className="p-3 text-sm text-slate-700">{a.date}</td>
          
                          <td className="p-3 font-bold text-slate-900 text-sm">{a.client_name ||
                            '-'}</td>
                          ...
                          <td className="p-3 text-center">
                             ...
                             <span className={`px-2 py-1 rounded text-[10px] font-bold uppercase ${a.payment_status === 'Paid' ?
                              'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'}`}>{a.payment_status}</span>
                          </td>
                          <td className={`p-3 text-right font-bold text-sm ${a.txn_type === 'Income' ?
                            'text-green-700' : 'text-red-700'}`}>{a.txn_type === 'Income' ? '+' : '-'} {a.amount}</td>
                          <td className="p-3 flex justify-center gap-2 no-print">
                             <button onClick={() => { setFormData(a);
                              setModalMode('addTxn'); }} className="text-blue-600 hover:bg-blue-100 p-1 rounded"><Edit3 size={16}/></button>
            ...
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 no-print">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    ...
                    <button onClick={() => { setFormData({ loan_category: loanTab, action: 'Add', date: today, person_name: '', amount: '', note: '' }); setModalMode('addLoanTxn');
                      }} className="bg-slate-900 text-white px-6 py-2 rounded font-bold hover:bg-[#c5a059] flex items-center gap-2">
              ...
              <div className="flex gap-0 mb-4 border-b-2 border-slate-300">
                  <button onClick={() => setLoanTab('Taken')} className={`px-6 py-3 font-bold text-lg transition-all ${loanTab === 'Taken' ?
                    'border-b-4 border-red-600 text-slate-900 bg-white' : 'text-gray-500 hover:text-slate-700'}`}>
                      My Debts
                  </button>
                  <button onClick={() => setLoanTab('Given')} className={`px-6 py-3 font-bold text-lg transition-all ${loanTab === 'Given' ?
                    'border-b-4 border-green-600 text-slate-900 bg-white' : 'text-gray-500 hover:text-slate-700'}`}>
                      Loans Given
                  </button>
              </div>
              ...
              <div className="bg-white p-6 rounded shadow border-l-4 border-[#c5a059]">
                  <p 
                  className="text-sm font-bold text-gray-500 uppercase">Total Outstanding Balance</p>
                  <p className={`text-3xl font-bold ${loanTab === 'Taken' ?
                    'text-red-600' : 'text-green-600'}`}>৳{totalLoanBalance}</p>
              </div>
                      ...
                      <div key={idx} className="bg-white p-5 rounded shadow border border-slate-200 flex flex-col justify-between hover:shadow-lg transition">
                          ...
                          <div className="flex justify-between items-start mb-4">
                              ...
                              <div className="text-right">
                                  ...
                                  <p className={`text-2xl font-bold ${l.balance === 0 ?
                                    'text-slate-500' : loanTab === 'Taken' ? 'text-red-600' : 'text-green-600'}`}>
                                      ৳{l.balance}
                                  </p>
                          ...
                          <div className="flex gap-2 border-t pt-4">
                              <button onClick={() => { 
                                setFormData({ person_name: l.person_name, loan_category: l.loan_category, action: 'Add', date: today, amount: '', note: '' }); setModalMode('addLoanTxn');
                                }} className="flex-1 bg-slate-100 text-slate-900 py-2 rounded text-xs font-bold hover:bg-slate-200 flex justify-center items-center gap-1">
                                  <TrendingUp size={14}/> Add Amount
                              </button>
                     
                              <button onClick={() => { setFormData({ person_name: l.person_name, loan_category: l.loan_category, action: 'Repay', date: today, amount: '', note: '' });
                                setModalMode('addLoanTxn'); }} className="flex-1 bg-slate-100 text-slate-900 py-2 rounded text-xs font-bold hover:bg-slate-200 flex justify-center items-center gap-1">
                                  <CheckCircle size={14}/> Repay / Adjust
                              </button>
                   
                              <button onClick={() => { setSelectedCase(l); setModalMode('viewLoanHistory');
                                }} className="p-2 bg-blue-50 text-blue-600 rounded hover:bg-blue-100" title="History">
                                  <History size={18}/>
                              </button>
                          </div>
            ...
            <div className="bg-white w-full max-w-lg rounded-xl shadow-2xl">
               ...
               <div className="p-6 space-y-4">
                  <div className="flex gap-2">
                      ...
                      <button onClick={() => setFormData({...formData, txn_type: 'Income'})} className={`flex-1 py-2 rounded font-bold ${formData.txn_type === 'Income' ?
                        'bg-green-600 text-white' : 'bg-gray-100 text-slate-900'}`}>Income</button>
                      <button onClick={() => setFormData({...formData, txn_type: 'Expense'})} className={`flex-1 py-2 rounded font-bold ${formData.txn_type === 'Expense' ?
                        'bg-red-600 text-white' : 'bg-gray-100 text-slate-900'}`}>Expense</button>
                  </div>
      ...
      {modalMode === 'addTask' && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-xl shadow-2xl overflow-hidden">
            <div className="bg-slate-900 p-4 text-white flex justify-between">
              <h3 
              className="font-bold flex items-center gap-2"><CheckSquare/> New Task</h3>
              <button onClick={() => setModalMode(null)}><X/></button>
            </div>
            <div className="p-6 space-y-4">
               <div>
               ...
               <div>
                  ...
                  <textarea rows="2" placeholder="Details..." value={formData.details} onChange={e => setFormData({...formData, 
                    details: e.target.value})} className="w-full border p-3 rounded text-slate-900"/>
               </div>
          ...
          <div className="bg-white w-full max-w-md rounded-xl shadow-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-4">
                ...
                <div className="bg-slate-100 p-3 rounded mb-4">
                  ...
                  <p className="text-xl font-bold text-slate-900">{formData.case_no ||
                    'N/A'}</p>
               </div>
               <div>
                  <label className="block text-xs font-bold text-red-700 mb-1">New Date</label>
                  <input type="date" value={formData.next_date ||
                    ''} onChange={e => setFormData({...formData, next_date: e.target.value})} className="w-full border-2 border-red-200 p-3 rounded text-slate-900 bg-white font-bold"/>
               </div>
               <div>
                  <label className="block text-xs font-bold text-red-700 mb-1">New Step</label>
                  <input value={formData.current_step ||
                    ''} onChange={e => setFormData({...formData, current_step: e.target.value})} className="w-full border-2 border-red-200 p-3 rounded text-slate-900 bg-white font-bold"/>
               </div>
               <div>
                  <label className="block text-xs font-bold text-red-700 mb-1">Update Note / Order</label>
                  <textarea rows="3" value={formData.note ||
                    ''} onChange={e => setFormData({...formData, note: e.target.value})} placeholder="আদেশের সারাংশ বা নতুন নোট লিখুন..." className="w-full border-2 border-red-200 p-3 rounded text-slate-900 bg-white"></textarea>
               </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-4xl rounded-xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 grid md:grid-cols-2 gap-4">
               ...
               className="text-xs font-bold text-slate-700">Court Name</label>
               ...
               <div className="space-y-1"><label className="text-xs font-bold text-slate-700">File No (ফাইল নম্বর)</label>
                ...
                <input value={formData.file_no ||
                  ''} onChange={e => setFormData({...formData, file_no: e.target.value})} className="w-full border p-2 rounded text-slate-900"/></div>
               ...
               <select value={formData.status} onChange={e => setFormData({...formData, 
                 status: e.target.value})} className="w-full border p-2 rounded text-slate-900 bg-white">
                     ...
                     <div className="bg-blue-50 p-4 rounded flex gap-2 items-end mb-4 border border-blue-200">
                        ...
                        <div className="flex-1 space-y-1">
                           ...
                           <input placeholder="e.g.
                             Certified Copy" className="w-full p-2 border rounded text-sm text-slate-900"
          ...
          <div className="bg-white w-full max-w-md rounded-xl shadow-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-4">
                <div>
                    ...
                    text-slate-700">Person / Organization Name</label>
                    <input value={formData.person_name} onChange={e => setFormData({...formData, person_name: e.target.value})} placeholder="e.g.
                      Rahim, Bank, etc." className="w-full border p-3 rounded text-slate-900" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                    <div>
                ...
                <div>
                    ...
                    => setFormData({...formData, date: e.target.value})} className="w-full border p-3 rounded text-slate-900" />
                </div>
                <div>
         ...
         <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-lg rounded-xl shadow-2xl overflow-hidden">
            ...
            <div className="p-4 bg-slate-50 border-b flex justify-between items-center">
                ...
                <span className={`text-xl font-bold ${selectedCase.loan_category === 'Taken' ?
                  'text-red-600' : 'text-green-600'}`}>৳{selectedCase.balance}</span>
            </div>
